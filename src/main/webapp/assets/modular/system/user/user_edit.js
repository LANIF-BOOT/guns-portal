...
layui.use(['layer', 'form', 'admin', 'laydate', 'ax'], function () {
    ...
    //获取用户信息
    var ajax = new $ax(Feng.ctxPath + "/manage/mgr/getUserInfo?userId=" + Feng.getUrlParam("userId"));
    ...
    $('#deptName').click(function () {
        ...
        var treeUrl = encodeURIComponent("/manage/dept/tree");
    ...
    form.on('submit(btnSubmit)', function (data) {
        var ajax = new $ax(Feng.ctxPath + "/manage/mgr/edit", function (data) {
            Feng.success("修改成功！");
