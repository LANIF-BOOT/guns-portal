layui.use(['layer', 'form', 'table', 'admin', 'ax'], function () {
    ...
    Role.openAddRole = function () {
        ...
        top.layui.admin.open({
            type: 2,
            title: '添加角色',
            content: Feng.ctxPath + '/manage/role/role_add',
            end: function () {
    ...
    Role.onEditRole = function (data) {
        ...
        top.layui.admin.open({
            type: 2,
            title: '修改角色',
            content: Feng.ctxPath + '/manage/role/role_edit?roleId=' + data.roleId,
            end: function () {
                admin.getTempData('formOk') && table.reload(Role.tableId);
            }
        });
    ...
    Role.onDeleteRole = function (data) {
        var operation = function () {
            var ajax = new $ax(Feng.ctxPath + "/manage/role/remove", function () {
                Feng.success("删除成功!");
    ...
    Role.roleAssign = function (data) {
        layer.open({
            ...
            fix: false,
            maxmin: true,
            content: Feng.ctxPath + '/manage/role/role_assign/' + data.roleId,
            end: function () {
                table.reload(Role.tableId);
            }
        });
    ...
    var tableResult = table.render({
        elem: '#' + Role.tableId,
        url: Feng.ctxPath + '/manage/role/list',
        page: true,
        height: "full-98",
        cellMinWidth: 100,
