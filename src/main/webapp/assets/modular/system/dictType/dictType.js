layui.use(['table', 'ax'], function () {
        ...
        return [[
            ...
            {field: 'dictTypeId', hide: true, title: '字典类型id'},
            {
                field: 'name', sort: true, title: '类型名称', templet: function (d) {
                    var url = Feng.ctxPath + '/manage/dict?dictTypeId=' + d.dictTypeId;
    ...
    DictType.openAddDlg = function () {
        window.location.href = Feng.ctxPath + '/manage/dictType/add';
    };
    ...
    DictType.openEditDlg = function (data) {
        window.location.href = Feng.ctxPath + '/manage/dictType/edit?dictTypeId=' + data.dictTypeId;
    };
    ...
    DictType.onDeleteItem = function (data) {
        var operation = function () {
            var ajax = new $ax(Feng.ctxPath + "/manage/dictType/delete", function (data) {
                Feng.success("删除成功!");
    ...
    var tableResult = table.render({
        ...
        url: Feng.ctxPath + '/manage/dictType/list',
        page: true,
        height: "full-98",
        cellMinWidth: 100,
