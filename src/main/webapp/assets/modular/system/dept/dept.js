layui.use(['table', 'admin', 'ax', 'ztree'], function () {
    ...
    Dept.openAddDept = function () {
        ...
        top.layui.admin.open({
            type: 2,
            title: '添加部门',
            content: Feng.ctxPath + '/manage/dept/dept_add',
            end: function () {
    ...
    Dept.onEditDept = function (data) {
        ...
        top.layui.admin.open({
            type: 2,
            title: '修改部门',
            content: Feng.ctxPath + '/manage/dept/dept_update?deptId=' + data.deptId,
            end: function () {
                admin.getTempData('formOk') && table.reload(Dept.tableId);
            }
        });
    ...
    Dept.onDeleteDept = function (data) {
        var operation = function () {
            var ajax = new $ax(Feng.ctxPath + "/manage/dept/delete", function () {
                Feng.success("删除成功!");
    ...
    var tableResult = table.render({
        elem: '#' + Dept.tableId,
        url: Feng.ctxPath + '/manage/dept/list',
        page: true,
        height: "full-98",
        cellMinWidth: 100,
