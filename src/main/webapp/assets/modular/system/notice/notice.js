layui.use(['layer', 'form', 'table', 'admin', 'ax'], function () {
    ...
    Notice.openAddNotice = function () {
        ...
        top.layui.admin.open({
            type: 2,
            title: '添加通知',
            content: Feng.ctxPath + '/manage/notice/notice_add',
            end: function () {
    ...
    Notice.onEditNotice = function (data) {
        ...
        top.layui.admin.open({
            type: 2,
            title: '通知详情',
            content: Feng.ctxPath + '/manage/notice/notice_update/' + data.noticeId,
            end: function () {
                admin.getTempData('formOk') && table.reload(Notice.tableId);
            }
        });
    ...
    Notice.onDeleteNotice = function (data) {
        var operation = function () {
            var ajax = new $ax(Feng.ctxPath + "/manage/notice/delete", function (data) {
                Feng.success("删除成功!");
    ...
    var tableResult = table.render({
        elem: '#' + Notice.tableId,
        url: Feng.ctxPath + '/manage/notice/list',
        page: true,
        height: "full-98",
        cellMinWidth: 100,
